...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_HOLYDAMAGE, minDamage = -1200, maxDamage = -1480, radius = 3, effect = CONST_ME_HOLYDAMAGE, target = true},
	{name ="combat", interval = 2000, chance = 14, type = COMBAT_ENERGYDAMAGE, minDamage = -1200, maxDamage = -1480, range = 7, shootEffect = CONST_ANI_ENERGY, target = false}
}
