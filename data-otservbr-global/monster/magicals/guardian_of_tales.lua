...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 13, type = COMBAT_ENERGYDAMAGE, minDamage = -500, maxDamage = -905, radius = 3, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -700, maxDamage = -1000, length = 5, spread = 3, effect = CONST_ME_MAGIC_RED, target = false},
